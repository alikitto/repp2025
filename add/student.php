...
// ------ читаем flash из сессии и сразу очищаем ------
...
<!-- Модалка успеха — показываем ТОЛЬКО когда есть flash -->
  ...
  <div class="modal-card">
    ...
    <div class="modal-actions">
      <a class="btn" href="/profile/student.php?user_id=<?= $createdId ?>">
        <svg class="btn-ic" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          <circle cx="12" cy="7" r="4"/><path d="M6 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/>
        </svg> Карточка ученика
      </a>
